...
//            ['foo', 2, 5],
//            ['Aged Brie', 2, 5],
//            ['Backstage passes to a TAFKAL80ETC concert', 2, 5],
//            ['Sulfuras, Hand of Ragnaros', 2, 5],
//        ];
//    }
//
...
//        $this->assertSame($name.', 1, 4', $itemString);
//
//        $itemValues = explode(',', $itemString);
//        $itemString = $this->runUpdateQuality($itemValues[0], $itemValues[1], $itemValues[2]);
//        $this->assertSame($name.', 0, 3', $itemString);
//
//        $itemValues = explode(',', $itemString);
//        $itemString = $this->runUpdateQuality($itemValues[0], $itemValues[1], $itemValues[2]);
//        $this->assertSame($name.', -1, 1', $itemString);
//
//        $itemValues = explode(',', $itemString);
//        $itemString = $this->runUpdateQuality($name, -1, 1);
//        $this->assertSame($name.', -2, 0', $itemString);
//    }
